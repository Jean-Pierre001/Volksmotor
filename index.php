      ...
      <div class="absolute inset-0 transition-opacity duration-1000 ease-in-out opacity-100" data-carousel-item>
        ...
        <div class="absolute top-1/3 left-16 text-white space-y-4">
          ...
          <div class="flex flex-col sm:flex-row gap-4 mt-6">
            <a class="openModal px-8 py-3 bg-white text-blue-700 font-semibold rounded-full shadow-lg hover:bg-gray-200 transition">
              Solicitar un asesor
            </a>
            <button class="openModal px-8 py-3 border-2 border-white text-white font-semibold rounded-full shadow-lg hover:bg-white hover:text-black transition">
              Reservar
            </button>
          </div>
        </div>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-2 gap-10">
        <div class="space-y-4">
          ...
          Media Plus o VM Play (2025), volante multifunción</p>
        ...
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-2xl overflow-hidden">
          ...
          <div class="p-5">
            ...
            <div class="flex flex-col gap-4 mt-6">
              <a href="#asesor" class="openModal px-8 py-3 border-2 border-blue bg-white text-blue-700 font-semibold rounded-full shadow-lg hover:bg-gray-200 transition text-center">
                Ver Mas
              </a>
              <a href="#whatsapp" class="openModal px-8 py-3 border-2 border-blue text-black font-semibold rounded-full shadow-lg hover:bg-gray-200 hover:text-black transition text-center">
                Reservar
              </a>
            </div>
          </div>
